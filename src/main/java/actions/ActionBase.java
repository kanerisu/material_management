...
public abstract class ActionBase {
    ...
    /**
     * 初期化処理
     * サーブレットコンテキスト、リクエスト、レスポンスをクラスフィールドに認定
    ...
    protected void invoke() throws ServletException,IOException{
        ...
        try {
            ...
            //（例：action=Item command=showの場合 ItemActionクラスのshow()メソッドを実行する）
            ...
            //発生した例外をコンソールに表示
            e.printStackTrace();
            //command値が不正で実行できない場合エラー画面を呼び出し
